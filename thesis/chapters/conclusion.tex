...
\begin{enumerate}
    ...
    \item a pooled PCA method for extracting stable meta-axes from within-emotion residuals, each causally active in generation without altering emotion category; and
